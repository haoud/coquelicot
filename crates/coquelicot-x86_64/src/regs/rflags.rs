...
/// Read the RFLAGS register on the current core and return its value.
#[inline]
#[must_use]
pub fn read() -> Flags {
    let rflags;
...
/// Enable the specified flags in the RFLAGS register on the current core.
///
/// # Safety
...
/// Disable the specified flags in the RFLAGS register on the current core.
///
/// # Safety
/// This is unsafe because modifying the RFLAGS register can have unexpected
/// side effects on the CPU and the system as a whole. Therefore, the caller
